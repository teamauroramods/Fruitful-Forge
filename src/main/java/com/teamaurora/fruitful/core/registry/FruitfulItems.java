...
public class FruitfulItems {
    ...
    public static class Foods {
        public static final Food BAKED_APPLE = new Food.Builder().hunger(6).saturation(0.4F).effect(()->new EffectInstance(FruitfulEffects.NOURISHING.get(), 240, 0, false, false, true), 1.0F).build();
    }
}
