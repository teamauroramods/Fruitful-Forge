...
public class FruitfulItems {
    ...
    public static final RegistryObject<Item> APPLE_CRUMBLE = HELPER.createItem("apple_crumble", ()->new SoupItem(new Item.Properties().food(FruitfulFoods.APPLE_CRUMBLE).group(ItemGroup.FOOD)));
