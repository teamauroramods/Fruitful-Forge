...
public class FruitfulItems {
    ...
    public static final RegistryObject<Item> APPLE_CRUMBLE = HELPER.createItem("apple_crumble", ()->new SoupItem(new Item.Properties().food(FruitfulFoods.APPLE_CRUMBLE).group(ItemGroup.FOOD).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> PEACH_COBBLER = HELPER.createItem("peach_cobbler", ()->new SoupItem(new Item.Properties().food(FruitfulFoods.PEACH_COBBLER).group(ItemGroup.FOOD).maxStackSize(1)));
